    ...
    <>
      ...
      <div className="md:hidden fixed bottom-4 left-0 right-0 z-[60] pointer-events-none pb-[env(safe-area-inset-bottom)] flex justify-center">
        <button 
          ...
          className="pointer-events-auto flex items-center gap-2 bg-[#111]/90 backdrop-blur-md border border-white/10 text-white px-6 py-3 rounded-full shadow-2xl hover:text-tpc-orange hover:border-tpc-orange/50 active:scale-95 transition-all"
        >
