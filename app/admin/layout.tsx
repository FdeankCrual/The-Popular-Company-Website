...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="admin-panel fixed inset-0 z-[10000] bg-tpc-black text-white flex flex-col md:flex-row overflow-hidden font-sans cursor-default">
      ...
      {/* MAIN CONTENT AREA */}
      <main className="flex-1 flex flex-col bg-tpc-black pt-[calc(64px+env(safe-area-inset-top))] md:pt-0 min-h-0 min-w-0">
        <div className="max-w-[1600px] w-full mx-auto flex-1 flex flex-col min-h-0 min-w-0">
          {children}
        </div>
      </main>
