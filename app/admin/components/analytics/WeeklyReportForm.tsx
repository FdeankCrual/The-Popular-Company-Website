    ...
    <div className="bg-[#111] border border-white/10 rounded-2xl flex flex-col h-full overflow-hidden">
      ...
      <div className="p-4 border-b border-white/10 bg-[#0a0a0a] flex justify-between items-center shrink-0">
        ...
        <div className="flex gap-2">
          <button onClick={() => handleSave("Draft")} className="px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded text-xs font-bold uppercase tracking-widest transition-colors flex items-center gap-2">
            <Save className="w-4 h-4" /> Save Draft
          </button>
          <button onClick={() => handleSave("Submitted")} className="px-4 py-2 bg-tpc-orange hover:bg-white text-black rounded text-xs font-bold uppercase tracking-widest transition-colors flex items-center gap-2">
            Submit Report
          </button>
        </div>
      </div>
