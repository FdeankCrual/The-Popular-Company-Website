...
export default function HomeClient({
  ...
  return (
    <main className="bg-tpc-black min-h-screen text-white overflow-x-clip selection:bg-tpc-orange selection:text-black">
      ...
      {/* 4.5 EXPERT TRACK RECORD */}
      <section className="py-24 px-6 md:px-12 border-t border-b border-white/5 bg-white/5">
        <div className="max-w-[1400px] mx-auto text-center">
          <h2 className="text-sm font-mono text-tpc-orange uppercase tracking-[0.2em] mb-12">By The Numbers</h2>
          
          <div className="flex flex-col md:flex-row justify-center items-center gap-16 md:gap-24 mb-16">
            <div>
              <div className="text-6xl md:text-7xl font-black text-white mb-2">₹5.5Cr+</div>
              <div className="text-sm font-mono text-gray-400 uppercase tracking-widest">Revenue Generated</div>
            </div>
            <div className="hidden md:block w-px h-24 bg-white/10" />
            <div>
              <div className="text-6xl md:text-7xl font-black text-white mb-2">40k+</div>
              <div className="text-sm font-mono text-gray-400 uppercase tracking-widest">Qualified Leads</div>
            </div>
            <div className="hidden md:block w-px h-24 bg-white/10" />
            <div>
              <div className="text-6xl md:text-7xl font-black text-white mb-2">2x</div>
              <div className="text-sm font-mono text-gray-400 uppercase tracking-widest">Avg ROI</div>
            </div>
          </div>
